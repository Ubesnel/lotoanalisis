...
class LotteryNumber(models.Model):
    ...
    total_salidas_dia = fields.Integer(store=True, index=True, help="Total salidas de tarde")
    total_salidas_noche = fields.Integer(store=True, index=True, help="Total salidas de noche")

    cant_salidas_enero = fields.Integer(store=True, index=True, help="Cantidad de salidas Enero")
    cant_salidas_febrero = fields.Integer(store=True, index=True, help="Cantidad de salidas Febrero")
    cant_salidas_marzo = fields.Integer(store=True, index=True, help="Cantidad de salidas Marzo")
    cant_salidas_abril = fields.Integer(store=True, index=True, help="Cantidad de salidas Abril")
    cant_salidas_mayo = fields.Integer(store=True, index=True, help="Cantidad de salidas Mayo")
    cant_salidas_junio = fields.Integer(store=True, index=True, help="Cantidad de salidas Junio")
    cant_salidas_julio = fields.Integer(store=True, index=True, help="Cantidad de salidas Julio")
    cant_salidas_agosto = fields.Integer(store=True, index=True, help="Cantidad de salidas Agosto")
    cant_salidas_septiembre = fields.Integer(store=True, index=True, help="Cantidad de salidas Septiembre")
    cant_salidas_octubre = fields.Integer(store=True, index=True, help="Cantidad de salidas Octubre")
    cant_salidas_noviembre = fields.Integer(store=True, index=True, help="Cantidad de salidas Noviembre")
    cant_salidas_diciembre = fields.Integer(store=True, index=True, help="Cantidad de salidas Diciembre")
    total_domingo = fields.Integer(store=True, index=True, help="Cantidad de salidas Diciembre")
    total_lunes = fields.Integer(store=True, index=True, help="Cantidad de salidas Diciembre")
    total_martes = fields.Integer(store=True, index=True, help="Cantidad de salidas Diciembre")
    total_miercoles = fields.Integer(store=True, index=True, help="Cantidad de salidas Diciembre")
    total_jueves = fields.Integer(store=True, index=True, help="Cantidad de salidas Diciembre")
    total_viernes = fields.Integer(store=True, index=True, help="Cantidad de salidas Diciembre")
    total_sabado = fields.Integer(store=True, index=True, help="Cantidad de salidas Diciembre")
    total_semana_1 = fields.Integer(store=True, index=True, help="Cantidad de salidas Semana 1 (1 al 7)")
    total_semana_2 = fields.Integer(store=True, index=True, help="Cantidad de salidas Semana 2 (8 al 14)" )
    total_semana_3 = fields.Integer(store=True, index=True, help="Cantidad de salidas Semana 3 (15 al 21)")
    total_semana_4 = fields.Integer(store=True, index=True, help="Cantidad de salidas Semana 4 (22 al 28)")
    total_semana_5 = fields.Integer(store=True, index=True, help="Cantidad de salidas Últimos días (29, 30 y 31)")
